...
<!--End css header-leftmenu -->
 ...
 <section class="content-header">
            <h1 style="background-color:#DCDCDC;padding-top:10px;padding-bottom:10px;padding-left:10px;">
              บุคคล /
              <small><a>เพิ่มข้อมูลพนักงาน</a> </small>
            </h1>
          </section> 
      <br>
  ...
  <!-- <form role="form" class="form-horizontal" action="<?php echo url('/person-employee/create') ?>" method="post"> -->
    ...
    {!!  Form::open(['url'=>'/person-employee-create','class'=>'form-horizontal','files'=>true,'id'=>'ChkForm'])   !!}
<div class="row">
    <div class="col-md-12">
                    ...
                    <label for="Birthday" class="control-label col-sm-3">รหัสผ่านอีกครั้ง <b style="color:red;font-size:20px;">*</b></label>
                        <div class="col-sm-9">
                            <div class="input-group date">
                                ...
                                <input type="password" class="form-control pull-right" name="password" placeholder="ป้อนรหัสผ่านเดิม..." id="repassword" onBlur="ChkRePass()">
