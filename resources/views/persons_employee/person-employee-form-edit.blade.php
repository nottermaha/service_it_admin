...
<section class="content-header">
            <h1 style="background-color:#DCDCDC;padding-top:10px;padding-bottom:10px;padding-left:10px;">
              บุคคล /
              <small><a>แก้ไขข้อมูลพนักงาน</a> </small>
            </h1>
          </section> 
      <br>
  ...
  {!!  Form::open(['url'=>'/person-employee-edit','class'=>'form-horizontal','files'=>true,'id'=>'ChkForm'])   !!}
<div class="row">
    <div class="col-md-12">
...
<div class="row">
                    ...
                    <label for="Birthday" class="control-label col-sm-3">รูปประจำตัว</label>
                        <div class="col-sm-9">
                            <div class="input-group date">
                                ...
                                <input type="file" class="form-control pull-right" name="image_url" placeholder="รูปประจำตัว..." value="{{$image_url}}" >
                            </div>
                        </div> 
                </div>
    ...
    <div class="col-md-6">
            @if(session()->has('status_confirm_password_emp_fail'))  
            <div class="alert alert-warning alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-warning"></i> แก้ไขข้อมูลส่วนตัวพนักงานล้มเหลว!</h4>
                    ...
                    <label for="Birthday" class="control-label col-sm-3">รหัสผ่าน <b style="color:red;font-size:20px;">*</b></label>
                        <div class="col-sm-9">
                            <div class="input-group date">
                                ...
                                <input type="password" class="form-control pull-right" name="" placeholder="รหัสผ่าน..." value="{{$password}}" >
                            </div>
                        </div>  
                </div> -->
                    ...
                    <label for="Birthday" class="control-label col-sm-3">ตำแหน่ง</label>
                        <div class="col-sm-9">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="Position" name="position" placeholder="ตำแหน่ง..." value="{{$position}}" disabled>
                            </div>
                        </div> 
                </div> 
                    ...
                    <label for="Birthday" class="control-label col-sm-3">วันเข้าเป็นพนักงาน</label>
                        <div class="col-sm-9">
                            <div class="input-group date">
                                ...
                                <input type="date" class="form-control pull-right" id="" name="date_in" placeholder="วันเข้าเป็นพนักงาน..." data-date-format="yyyy-mm-dd" value="{{$date_in}}">
                            </div>
                        </div>
                </div> 
                        ...
                        <div class="col-sm-9">
                            <div class="input-group date">
                                <div class="input-group-addon">
                                    ...
                                    <input type="date" class="form-control pull-right" id="" name="date_out" placeholder="วันออกจากงาน..." data-date-format="yyyy-mm-dd" value="{{$date_out}}">
                                </div>
                            </div>
                        </div> 
                </div>
