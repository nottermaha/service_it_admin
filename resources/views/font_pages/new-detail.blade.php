...
<title> Single post | Monarch </title>
...
<div class="owl-slider-1 radius-all-4 slider-wrapper">
    <div>
        <img src="" data-original="assets/image-resources/stock-images/img-38.jpg" class="lazy radius-all-4 img-full">
    </div>
    <div>
        <img src="" data-original="assets/image-resources/stock-images/img-37.jpg" class="lazy radius-all-4 img-full">
    </div>
    <div>
        <img src="" data-original="assets/image-resources/stock-images/img-36.jpg" class="lazy radius-all-4 img-full">
    </div>
    <div>
        <img src="" data-original="assets/image-resources/stock-images/img-35.jpg" class="lazy radius-all-4 img-full">
    </div>
    <div>
        <img src="" data-original="assets/image-resources/stock-images/img-34.jpg" class="lazy radius-all-4 img-full">
    </div>
</div>
        </div>
    </div>
