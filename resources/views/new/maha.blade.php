...
<div class="hero-box hero-box-smaller full-bg-13 font-inverse" data-top-bottom="background-position: 50% 0px;" data-bottom-top="background-position: 50% -600px;">
    <div class="container">
        <h1 class="hero-heading wow fadeInDown" data-wow-duration="0.6s">Components framework</h1>
        <p class="hero-text wow bounceInUp" data-wow-duration="0.9s" data-wow-delay="0.2s">Example page with blog posts list build with MonarchUI</p>
    </div>
...
<div id="page-content" class="col-md-10 center-margin frontend-components mrg25T">
    ...
    <div class="panel">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" class="display-block" href="#Forms">
                    Forms UI
                    <i class="glyph-icon icon-angle-right float-right"></i>
                </a>
            </h4>
    ...
    <div class="panel">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" class="display-block" href="#Advanced">
                    Advanced tables
                    <i class="glyph-icon icon-angle-right float-right"></i>
                </a>
            </h4>
    ...
    <div class="panel">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" class="display-block" href="#Charts">
                    Charts
                    <i class="glyph-icon icon-angle-right float-right"></i>
                </a>
            </h4>
    ...
    <div class="panel">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" class="display-block" href="#Helpers">
                    Helpers
                    <i class="glyph-icon icon-angle-right float-right"></i>
                </a>
            </h4>
        </div>
        <div id="Helpers" class="panel-collapse collapse">
            <div class="panel-body">
                <ul class="nav">
...
<div id="page-title">
    <h2>Blog posts</h2>
    <p>Example page with blog posts list build with MonarchUI</p>
...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <div class="list-group mrg20B">
            <a href="#" class="list-group-item bg-white">
            ...
            <a href="#" class="list-group-item bg-white disabled">
        ...
        <div class="content-box">
            ...
            <div class="content-box-wrapper clearfix tags-list">
                <a href="#" title="" class="bs-label label-black">Moment</a>
                <a href="#" title="" class="bs-label label-black">Hand</a>
                <a href="#" title="" class="bs-label label-success">Gadgets</a>
                <a href="#" title="" class="bs-label label-warning">Demoralized</a>
                <a href="#" title="" class="bs-label label-success">Advantage</a>
                <a href="#" title="" class="bs-label label-black">Example</a>
                <a href="#" title="" class="bs-label label-black">Explorer</a>
                <a href="#" title="" class="bs-label label-warning">Demoralized</a>
                <a href="#" title="" class="bs-label label-success">Advantage</a>
                <a href="#" title="" class="bs-label label-black">Example</a>
                <a href="#" title="" class="bs-label label-black">Explorer</a>
                <a href="#" title="" class="bs-label label-black">Born</a>
            </div>
        </div>
        <div class="owl-slider-1 radius-all-4 slider-wrapper">
            <div>
                <img src="assets/image-resources/stock-images/img-38.jpg" class="radius-all-4 img-full">
            </div>
            <div>
                <img src="assets/image-resources/stock-images/img-37.jpg" class="radius-all-4 img-full">
            </div>
            <div>
                <img src="assets/image-resources/stock-images/img-36.jpg" class="radius-all-4 img-full">
            </div>
            <div>
                <img src="assets/image-resources/stock-images/img-35.jpg" class="radius-all-4 img-full">
            </div>
            <div>
                <img src="assets/image-resources/stock-images/img-34.jpg" class="radius-all-4 img-full">
            </div>
        </div>
